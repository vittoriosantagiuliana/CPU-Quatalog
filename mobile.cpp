...
Mobile::Mobile(int manufacturer, const std::string &model, int socketId, int year, int cores, int threads, int nm, int w, bool bits) : CPU(manufacturer, model, socketId, year, cores, threads, nm, w, bits, false)
{
...
const std::map<const int, const std::string> Mobile::sockets({std::pair<const int, const std::string>(0, "Socket 7"),

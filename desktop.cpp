...
Desktop::Desktop(const int manufacturer, const std::string &model, const int socketId, const int year, const int cores, const int threads, const int nm, const int w, const bool bits, const bool ecc) : CPU(manufacturer, model, socketId, year, cores, threads, nm, w, bits, ecc)
{
...
const std::map<const int, const std::string> Desktop::sockets({std::pair<const int, const std::string>(0, "Socket 1"),
